...
In Death and the value  of life Jeff McMahan explains that the view presupposes at least the existence requirement: 
a person can be the subject of some misfortune only if he exists at the time the misfortune occurs. 
He thinks to be able to deny this claim with the Man (call him S) on an Island consideration. 
This consideration goes like this: S is on the island and their life's work is on the mainland. The existence requirement seems to imply that if the subject dies just prior to the destruction of their life work then they do not suffer a misfortune, while if the subject dies just after the destruction of their life work they do suffer a misfortune and this seems absurd. 
More is said in the paper about how experience is necessary for misfortune. The two views that McMahan introduces are 
The narrow experience requirement: an experience can be bad for a person only if the person experiences it as bad and 
The wide experience requirement: an experience can be bad for a person only if it affects or makes a difference to their conscious experience. 
...
Thus, in this paper I will be concerned with the embodied mind account (McMahan's position on personal identity) two solutions to the mind body problem that may or may not support this account and a presentation of the position with respect to death I will call the 'unknown mark of death Unknown value view'.

McMahan writes, when speaking about his Embodied mind account:

I differ from these authors  primarily in thinking that identity requires less structural or organization continuity in the brain than they believe is necessary. While they believe that identity requires sufficient structural continuity to preserve certain continuities in the content of an individual's mental life, I believe that there need be only enough physical and functional continuity to preserve certain basic psychological capacities, particularly the capacity for consciousness.
...
2: if I am right about point 1 and 1.2, it implies a very different interpretation of McMahan's text as well as about the ethical considerations we ought to have concerning accepting Epicurus's view, killing, bringing into existence and the badness of death. Under point 2, only Epicurus's view and the badness of death I will be able to speak about. I will spend some time belaboring point 1 because it matters so much what the correct view on these continuities is.
...
I mean to presuppose neither theory is correct in this paper—it will be enough to show that which is correct is controversial . 

That being said, it is a substantial question what the relationship is between meaning and content on any solution to the mind/body problem. A useful way to consider content on these theories ought to be according to two solutions to the mind body problem which may both equally well elaborate on the distinction McMahan's wants to make. 

The theories I have in mind are the psychophysical identity theory and the functional theory of mind . 

The psychophysical identity theory is what it sounds like: the brain is the mind. 

In contrast Functionalism says that the mind is a causally organized set of well defined functions. Functionalism is, arguably, the most widely accepted account of the mind.

We may define the identity of a function in the following way: function A is identical to function A if and only if function A transforms some well defined range of input symbols into a well defined  range of output symbols.

How is meaning integrated into these theories and what does this mean for the functional/structural distinction? 
On the psychophysical identity theory meaning is paired to physical facts in a brute way. On this view Jeff's comment does not make much sense. He writes that structural continuity is "those configurations of tissue that underlie the connections and continuities among the contents of an individual's mental life over time. " But the psychophysical identity theory does not care about configurations of tissue, all it cares about is the tissue; it does not care about the connections and continuities (of content)—it is just a useful consequence that these connections and continuities are preserved if sameness of brain is sameness of mind (that is, if the psychophysical identity theory is true). Further it seems intuitively compelling to many that it is a contingent physical fact that aspects of structure are preserved when physical structures are preserved in the actual world. But the point is that meaning is a brute fact tacked onto specific physical groups  on this theory (and we will return to the physical/functional difference under point 2 to consider why it may be a contingent fact). 
...
But to say that this representation is of what it is in the world, in virtue of some physical "configuration of tissues" being preserved is controversial. 

As I understand computational theories there are two competing accounts about what it is about the structure or architecture that preserves the content of the thing in the world the architecture is said to represent. Both are abstract and appeal to different actual causal structures for their explanatory value. 

They differ in that either the system as a whole  has the content or components of the system  have the content. 

The point to be made now is that to assert that whatever is responsible-for/preserves functional continuity (As McMahan has defined these above, i.e., whatever physically preserves basic psychological capabilities like attending to things, or having a mental image, or whatever could count as fundamental to having a mind,) will not preserve content, (i.e., the highly specific structure necessary for content,) cannot just be assumed but must be argued for.

One issue has to do with the extension of the causal structure necessary to preserve content. On some conceptions of the mind it is embodied or identical to the body. Others go further to suppose that the structure may be the human and other causal structures capable of bearing information in the world. If true this would suggests that the boundaries between the representing system and the objects/events to be represented differ in different worlds (or couter-factually in this world). These difficulties stem from considering differing "tissue" configurations sufficient and necessary for structural continuity (i.e., continuity of the content/meaning). On these wider views of content functional continuity (remember, under McMahan's view this is psychological capacity continuity) is just entailed by structural continuity.

Another issue can be motivated by considering Searle's Chinese Room Argument and responses to it . Searle's argument is aimed at the components account of content (classical computationalism) rather than the whole system account (connectionism), but it suffices to make the point that the claim "that whatever physically preserves basic psychological capabilities will not preserver content" is controversial—since classical computational theorists believe that the preservation of basic psychological capabilities (via the preservation of functions) is intimately connected to the preservation of the content (while opponents like Searle believe that no amount of syntax or functional organization will ever be sufficient to produce a semantics). 

Simply put, for psychological capacities are functions of the mind and if they do not preserve content then classical computationalism is not modeling human psychological capabilities. If it is possible to tease apart functional and structural continuity under functionalism it would mean to ask if the meaning of symbols input into the functions are equivalent as the function changes.
...
If one believes in the multiple realizability thesis very strongly then one may accept that functional continuity is enough to preserve identity and that the same physical material is not necessary. As McMahan points out in his book The Ethics of Kiling this is important since where one comes down on this issue will determine how one answers the question whether a person can survive being sent through a teletrasporter, how many people exist in the case of division/fusion and when a person is being killed. 
...
I will return to these issues at another time.
